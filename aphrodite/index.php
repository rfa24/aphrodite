...
<html lang="en">
  <head>
    ...
    <title>V'lash | Lash Extension Studio</title>
  ...
  <body>
    ...
    <div id="page">
          ...
          <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
            <ul>
              ...
              <li data-index="rs-16" data-transition="zoomout" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/slider1.jpg"  alt="slider"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
              </li>
              <!-- SLIDE  -->
      ...
      <section id="salon" class="col-padtop wow fadeInUp">
        <div class="container">
          <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6 col-padright-none wow fadeInLeft"><img src="assets/img/upper-img/1.png" alt="Saloon" /></div>
            <div class="col-sm-6 col-md-6 col-lg-6 col-padleft-none wow fadeInRight"><img src="assets/img/upper-img/2.png" alt="Saloon" /></div>
            <div class="col-sm-6 col-md-6 col-lg-6 col-padleft-none wow fadeInRight"><img src="assets/img/upper-img/3.png" alt="Saloon" /></div>
          </div>
        </div>
      </section>
              ...
              <div class="responsive">
                <div>
                  <div class="third-effect">
                    <img src="assets\img\lash-type\volume.png" class="img-responsive" alt="Our Team">
                  </div>
                  <div class="team">
                    <h3>Glam Volume</h3>
                ...
                <div>
                  <div class="third-effect">
                    <img src="assets\img\lash-type\soft.png" class="img-responsive" alt="Our Team">
                  </div>
                  <div class="team">
                    <h3>Soft Volume</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pulvinar luctus est eget congue. Nam auctor nisi est, nec tempus lacus.</p>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="portfoliodiv">
              <div class="col-25 coloring manucuring"> <a class="fancybox" href="images/1.jpg" data-fancybox-group="gallery">
                <div class="hover">
                  <img src="images/1.jpg" alt="Portfolio"/>
                  <div class="mask-img">
                    <div class="hvrlink">
                      <h3>Cut</h3>
            ...
            <div class="col-25 Wcut manucuring"> <a class="fancybox" href="images/2.jpg" data-fancybox-group="gallery">
              <div class="hover">
                <img src="images/2.jpg" alt="Portfolio"/>
                <div class="mask-img">
                  <div class="hvrlink">
                    <h3>Style</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
            ...
            <div class="col-25 coloring Hspa"> <a class="fancybox" href="images/3.jpg" data-fancybox-group="gallery">
              <div class="hover">
                <img src="images/3.jpg" alt="Portfolio"/>
                <div class="mask-img">
                  <div class="hvrlink">
                    <h3>Cut</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
            ...
            <div class="col-25 Wcut"> <a class="fancybox" href="images/4.jpg" data-fancybox-group="gallery">
              <div class="hover">
                <img src="images/4.jpg" alt="Portfolio"/>
                <div class="mask-img">
                  <div class="hvrlink">
                    <h3>Style</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
            ...
            <div class="col-25 coloring"> <a class="fancybox" href="images/5.jpg" data-fancybox-group="gallery">
              <div class="hover">
                <img src="images/5.jpg" alt="Portfolio"/>
                <div class="mask-img">
                  <div class="hvrlink">
                    <h3>Cut</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
            ...
            <div class="col-25 Bspa"> <a class="fancybox" href="images/6.jpg" data-fancybox-group="gallery">
              <div class="hover">
                <img src="images/6.jpg" alt="Portfolio"/>
                <div class="mask-img">
                  <div class="hvrlink">
                    <h3>Style</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
            ...
            <div class="col-25 Bspa"> <a class="fancybox" href="images/7.jpg" data-fancybox-group="gallery">
              <div class="hover">
                <img src="images/7.jpg" alt="Portfolio"/>
                <div class="mask-img">
                  <div class="hvrlink">
                    <h3>Cut</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
            ...
            <div class="col-25"> <a class="fancybox" href="images/8.jpg" data-fancybox-group="gallery">
              <div class="hover">
                <img src="images/8.jpg" alt="Portfolio"/>
                <div class="mask-img">
                  <div class="hvrlink">
                    <h3>Style</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing industry.</p>
                ...
                <div id="myCarousel-1" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner" role="listbox">
                    <div class="item active">
                      <div class="img-right"><img src="images/P-slide-1.jpg" alt="First slide" class="img-responsive"></div>
                    ...
                    <div class="item">
                      <div class="img-right"><img src="images/P-slide-2.jpg" alt="First slide" class="img-responsive"></div>
                    ...
                    <div class="item">
                      <div class="img-right"><img src="images/P-slide-3.jpg" alt="First slide" class="img-responsive"></div>
                      <div class="gbg-white col-pad4">
                        <h4>Happy Hair</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pulvinar luctus est eget congue. Nam auctor nisi est, nec tempus lacus viverra nec. Nullam cursus, neque non congue aliquam, mauris massa consequat sem, ut laoreet nisi erat et lectus.</p>
                      </div>
